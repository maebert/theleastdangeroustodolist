...
import { Text, Animated, View, TouchableHighlight, StyleSheet } from "react-native";
...
export default class Todo extends React.Component {
  renderTag() {
    ...
    renderBox() {
      return <TouchableHighlight underlayColor="white" style={{
        height: 32,
        width: 32,
        borderRadius: 4,
        borderWidth: 2,
      ...
      >
      <View style={{backgroundColor: this.props.done ? '#ffff' : "#fff0" , width: '100%', height: '100%', borderRadius: 2}}/>
      </TouchableHighlight>
    }
  ...
  getColor = () => {
    ...
    return fade.interpolate({
      inputRange: [0, 0.2, 0.2],
      outputRange: [Palette[palette][index], Palette.greys[index], Palette.greys[index]]
    });
  }
